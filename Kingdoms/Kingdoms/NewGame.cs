...
namespace Kingdoms
{
    ...
    public class NewGame
    {
        ...
        public void Update(GameTime GT,Game1 game1)
        {
            ...
            Start.Pos=new Vector2((NewBoxpos.X+Newbox.Width-256-8),(NewBoxpos.Y+Newbox.Height-64-8));
            mainmenu.Pos=new Vector2((NewBoxpos.X+8), (NewBoxpos.Y+Newbox.Height-64-8));            


            MouseState mus = Mouse.GetState();
            musp = new Vector2(mus.X, mus.Y);

            if (Start.state == MenuButton.BState.pressed)
            {
            ...
            else if (mainmenu.state == MenuButton.BState.pressed)
