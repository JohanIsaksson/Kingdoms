...
namespace Kingdoms
{
    public class Player
    {
        ...
        public void Income()
        {
            ...
            {
                if (item.typ == housetype)
                    houses++;
                if (item.typ == castletype)
                {
                    castlepositions.Add(item.Pos);
                    castles++;                    
                }
            }
        ...
        public void CheckWin()
        {
            ...
            {
                if (ruta.typ == pgame.Playermanager.player[pgame.Playermanager.notplaying].castletype)
                {
                    enemycastles++;
                }
            }
