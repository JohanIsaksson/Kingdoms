...
namespace Kingdoms
{
    public class UnitMenu
    {
        ...
        public void EnableBtn(Game1 game1)
        {
            ...
            if (game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == game1.Playermanager.player[game1.Playermanager.notplaying].housetype || game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == 25)
                Occupy.active = true;
            else if (game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == game1.Playermanager.player[game1.Playermanager.notplaying].castletype && game1.Playermanager.player[game1.Playermanager.playing].soldat[game1.Playermanager.player[game1.Playermanager.playing].currentUnit].type == 1)
                Occupy.active = true;
            else if (game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == 43 && game1.Playermanager.player[game1.Playermanager.playing].soldat[game1.Playermanager.player[game1.Playermanager.playing].currentUnit].type == 1)
                Occupy.active = true;
            else
                Occupy.active = false;
        ...
        public void Update(GameTime GT, Game1 game1)
        {
            ...
            else if (Occupy.state == UnitMenuButton.BState.pressed)
            {
                if (game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == game1.Playermanager.player[game1.Playermanager.notplaying].housetype || game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == 25)
                {
                    game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].SetTile(game1.Playermanager.player[game1.Playermanager.playing].housetype, (int)UnitPos.X, (int)UnitPos.Y);
                }
                else if (game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == 33 || game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].typ == 43)
                {
                    game1.Tilemanager.Map[(int)UnitPos.X, (int)UnitPos.Y].SetTile(game1.Playermanager.player[game1.Playermanager.playing].castletype, (int)UnitPos.X, (int)UnitPos.Y);
