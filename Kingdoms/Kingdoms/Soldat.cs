...
namespace Kingdoms
{
    public class Soldat
    {
        ...
        public void Update(GameTime GT, Game1 game)
        {
            ...
            {
                case "Blue":
                    if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 26)
                    {
                        BonusArmor = 5;
                        HpReg = 20;
                    }
                    else if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 27)
                    {
                        BonusArmor = 5;
                        HpReg = 20;
                    }
                ...
                case "Red":
                if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 32)
                {
                    BonusArmor = 5;
                    HpReg = 20;
                }
                else if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 33)
                {
                    BonusArmor = 5;
                    HpReg = 20;
                }
                ...
                case "Green":
                    if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 28)
                    {
                        BonusArmor = 5;
                        HpReg = 20;
                    }
                    else if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 29)
                    {
                        BonusArmor = 5;
                        HpReg = 20;
                    }
                ...
                case "Yellow":
                    if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 30)
                    {
                        BonusArmor = 10;
                        HpReg = 20;
                    }
                    else if (game.Tilemanager.Map[(int)Pos.X, (int)Pos.Y].typ == 31)
                    {
                        BonusArmor = 15;
                        HpReg = 20;
                    }
